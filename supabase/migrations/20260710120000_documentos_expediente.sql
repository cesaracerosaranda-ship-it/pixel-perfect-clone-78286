-- Expediente documental por cliente: guías de envío, comprobantes de pago,
-- facturas, cotizaciones de flete y PDFs de cotización archivados.
...
-- App interna sin auth (mismo criterio que el resto del schema)
...
-- Bucket de storage (público para poder abrir los archivos con liga directa)
