ALTER TABLE public.cotizaciones ADD COLUMN IF NOT EXISTS es_historica BOOLEAN NOT NULL DEFAULT false;
...
BEGIN
  ...
  ELSIF TG_OP = 'UPDATE' THEN
    IF NEW.es_historica = true OR OLD.es_historica = true THEN
      RETURN NEW;
    END IF;
...
FOR EACH ROW EXECUTE FUNCTION public.ajustar_inventario_cotizacion();